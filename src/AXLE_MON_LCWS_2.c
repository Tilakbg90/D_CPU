/*****************************************************************************
    ...
    Revision            :    1
    Module Version      :    1.0
    Component name      :    AXLE_MON_LCWS_2
...
void Initialise_AxleMon_2(void)
{
    ...
    Track_Info_2.US_Axle_Direction = (BYTE)DIRECTION_NOT_DEFINED;
    Track_Info_2.DS_Axle_Direction = (BYTE)DIRECTION_NOT_DEFINED;
    Track_Info_2.US_Axle_Count = 0;
    Track_Info_2.DS_Axle_Count = 0;

    Track_Info_2.LCWS_Axle_Direction = (BYTE)DIRECTION_NOT_DEFINED;
...
void Determine_TrackState_2(BYTE uchPD_IO_Value)
{
    ...
    switch (Track_Info_2.State)
    {
       ...
       Track_Info_2.State = (Axle_Counter_State)uchNewState;
...
#if NO_SHUNTING
    Track_Info_2.LCWS_Axle_Direction = (BYTE)FORWARD_DIRECTION;
...
void Register_PD2121_Transition_2(void)
{
    ...
    Track_Info_2.Trolley_Timeout_50ms = TROLLEY_TIMEOUT;
#if NO_SHUNTING
    Track_Info_2.LCWS_Axle_Direction = (BYTE)REVERSE_DIRECTION;
    Track_Info_2.LCWS_Rev_Count = Track_Info_2.LCWS_Rev_Count + 1;
    if (Track_Info_2.LCWS_Total_Rev_Count >= MAX_AXLE_COUNTS)
    {
        Track_Info_2.LCWS_Total_Rev_Count = 0;
