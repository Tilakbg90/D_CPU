/*****************************************************************************
    ...
    Functions   :   void Initialise_AxleMon(void)
                    ...
                    void Monitor_Wheel_Pulse_2(void)
                    void Determine_TrackState_2(BYTE uchPD_IO_Value)
                    void Analyse_Supervisory_Sequence_2(void)
                    void Detect_PD_Failures_2(void)
                    ...
                    void Register_PD1212_Transition_2(void)
                    void Register_PD2121_Transition_2(void)
                    ...
                    void Clear_PD1_Supervisory_Count_2(void)
                    void Clear_PD2_Supervisory_Count_2(void)
                    void Clear_PD12_Main_Pulse_Count_2(void)
                    void Clear_Wheel_Type_2(void)
...
extern  /*near*/  dip_switch_info_t DIP_Switch_Info;      /* from DAC_MAIN.c */
 /*near*/  track_info_t Track_Info_2;
extern fdp_info FDP_Info;


extern const BYTE uchPD_Transition_Table[NO_OF_TRACK_PROCESS_STATES][NO_OF_PD_TRANSITIONS];
void Initialise_AxleMon_2(void);
void Validate_PD_Signals_2(void);
void Monitor_Supervisory_Pulse_2(void);
void Monitor_Wheel_Pulse_2(bitadrb_t);
void Determine_TrackState_2(BYTE);
void Analyse_Supervisory_Sequence_2(void);
void Register_PD1212_Transition_2(void);
void Register_PD2121_Transition_2(void);
void Clear_PD1_Supervisory_Count_2(void);
void Clear_PD2_Supervisory_Count_2(void);
void Clear_PD12_Main_Pulse_Count_2(void);
BOOL Chk_For_Track_Occupancy_2(void);
void Clear_Wheel_Type_2(void);
void Detect_PD_Failures_2(void);
void Clear_DS_AxleCount_2(void);
void Decrement_TrackMon_50msTmr_2(void);
/*********************************************************************
Component name      :AXLE_MON
...
Output Variables        Name                                Type
    Global          :   Track_Info_2.Flags.Train_Shunting       BYTE
...
//BYTE Get_Shunting_State(void)
//{
//  return((BYTE)Track_Info_2.Flags.Train_Shunting);
//}
...
Output Variables        Name                                                  Type
    Global          :   Track_Info_2.State                                      Enumerator
                        Track_Info_2.US_Axle_Direction                          BYTE
                        Track_Info_2.DS_Axle_Direction                          BYTE
                        Track_Info_2.US_Axle_Count                              UINT16
                        Track_Info_2.DS_Axle_Count                              UINT16
                        Track_Info_2.DS_Fwd_Axle_Count                          UINT16
                        Track_Info_2.DS_Rev_Axle_Count                          UINT16
                        Track_Info_2.US_Fwd_Axle_Count                          UINT16
                        Track_Info_2.US_Rev_Axle_Count                          UINT16
                        Track_Info_2.PD1M_Count                                 UINT16
                        Track_Info_2.PD2M_Count                                 UINT16
                        Track_Info_2.PD1S_Count                                 UINT16
                        Track_Info_2.PD2S_Count                                 UINT16
                        Track_Info_2.PD1S_Falling_Edge_Count                    UINT16
                        Track_Info_2.PD2S_Falling_Edge_Count                    UINT16
                        Track_Info_2.PD1S_Rising_Edge_Count                     UINT16
                        Track_Info_2.PD2S_Rising_Edge_Count                     UINT16
                        Track_Info_2.Wheel_Type                                 Enumarartor
                        Track_Info_2.Flags.PD_State_Counted                     Bit
                        Track_Info_2.Flags.Train_Shunting                       Bit
                        Track_Info_2.Flags.PD1S_Timer_On                        Bit
                        Track_Info_2.Flags.PD2S_Timer_On                        Bit
                        Track_Info_2.Flags.PD1S_Port_Latch                      Bit
                        Track_Info_2.Flags.PD2S_Port_Latch                      Bit
                        Track_Info_2.Flags.PD1M_Port_Latch                      Bit
                        Track_Info_2.Flags.PD2M_Port_Latch                      Bit
                        Track_Info_2.Flags.US_Counting_Enable                   Bit
                        Track_Info_2.Flags.DS_Counting_Enable                   Bit
                        Track_Info_2.PD_Last_Change_Timeout_50ms                BYTE
                        Track_Info_2.PD1S_Timeout_50ms                          UNIT16
                        Track_Info_2.PD2S_Timeout_50ms                          UNIT16
                        Track_Info_2.US_Local_Counts_Clearing_Flag_Timeout_50ms BYTE
                        Track_Info_2.DS_Local_Counts_Clearing_Flag_Timeout_50ms BYTE
                        Track_Info_2.Trolley_Timeout_50ms                       BYTE
...
void Initialise_AxleMon_2(void)
{
    Track_Info_2.State = PRE_SYNCHRONISATION_WAIT;
    Track_Info_2.US_Axle_Direction = DIRECTION_NOT_DEFINED;
    Track_Info_2.DS_Axle_Direction = DIRECTION_NOT_DEFINED;
    Track_Info_2.US_Axle_Count = 0;
    Track_Info_2.DS_Axle_Count = 0;

    Track_Info_2.LCWS_Axle_Direction = DIRECTION_NOT_DEFINED;
    Track_Info_2.LCWS_Count = 0;
    Track_Info_2.LCWS_Fwd_Count = 0;
    Track_Info_2.LCWS_Rev_Count = 0;
    Track_Info_2.LCWS_Total_Fwd_Count = 0;
    Track_Info_2.LCWS_Total_Rev_Count = 0;

    Track_Info_2.DS_Fwd_Axle_Count = 0;
    Track_Info_2.DS_Rev_Axle_Count = 0;
    Track_Info_2.US_Fwd_Axle_Count = 0;
    Track_Info_2.US_Rev_Axle_Count = 0;
    Track_Info_2.PD1M_Count = 0;
    Track_Info_2.PD2M_Count = 0;
    Track_Info_2.PD1S_Count = 0;
    Track_Info_2.PD2S_Count = 0;
    Track_Info_2.PD1S_Falling_Edge_Count = 0;
    Track_Info_2.PD2S_Falling_Edge_Count = 0;
    Track_Info_2.PD1S_Rising_Edge_Count  = 0;
    Track_Info_2.PD2S_Rising_Edge_Count  = 0;
    Track_Info_2.Wheel_Type = WHEEL_TYPE_NOT_DETERMINED;
    Track_Info_2.Flags.PD_State_Counted  = FALSE;
    Track_Info_2.Flags.PD1S_Timer_On = FALSE;
    Track_Info_2.Flags.PD2S_Timer_On = FALSE;
    Track_Info_2.Flags.PD1S_Port_Latch = SET_HIGH;
    Track_Info_2.Flags.PD2S_Port_Latch = SET_HIGH;
    Track_Info_2.Flags.PD1M_Port_Latch = SET_HIGH;
    Track_Info_2.Flags.PD2M_Port_Latch = SET_HIGH;
    Track_Info_2.Flags.US_Counting_Enable = SET_LOW;
    Track_Info_2.Flags.DS_Counting_Enable = SET_LOW;
    Track_Info_2.Flags.PD_Non_Overlapping = FALSE;
    Track_Info_2.Flags.PD_Without_Overlapping = FALSE;
    Track_Info_2.Flags.DS_Local_Counts_Just_Cleared = FALSE;
    Track_Info_2.Flags.US_Local_Counts_Just_Cleared = FALSE;
    Track_Info_2.Flags.FDP_US_Counting_Enable = SET_LOW;
    Track_Info_2.Flags.FDP_DS_Counting_Enable = SET_LOW;
    Track_Info_2.PD_Last_Change_Timeout_50ms = 0;
    Track_Info_2.PD1S_Timeout_50ms = 0;
    Track_Info_2.PD2S_Timeout_50ms = 0;
    Track_Info_2.US_Local_Counts_Clearing_Flag_Timeout_50ms = 0;
    Track_Info_2.DS_Local_Counts_Clearing_Flag_Timeout_50ms = 0;
    Track_Info_2.Trolley_Timeout_50ms = 0;
    
    TRISCbits.TRISC4 = 1;
    TRISBbits.TRISB4 = 1;

    if(PORTCbits.RC4 == SET_HIGH && PORTBbits.RB4 == SET_HIGH)
        {
        /* Both Leading and Trailing are high, so not necessary to synchronise */
           Track_Info_2.State = WAITING_FOR_AXLE;
        }
    else
       {
          Track_Info_2.State = OUT_OF_SYNC_OR_PD_ERROR;
...
Interfaces
    Calls           :   AXLE_MON.c  -   Monitor_Supervisory_Pulse()
                        AXLE_MON.c  -   Analyse_Supervisory_Sequence_2()
                        AXLE_MON.c  -   Determine_TrackState_2()
                        AXLE_MON.c  -   Monitor_Wheel_Pulse_2()
                        AXLE_MON.c  -   Detect_PD_Failures_2()
...
Input Variables         Name                                Type
    Global          :   Track_Info_2.Wheel_Type               Enumerator
...
void Validate_PD_Signals_2(void)
{
    ...
    Monitor_Supervisory_Pulse_2();
    if(Track_Info_2.Wheel_Type == WHEEL_TYPE_NOT_DETERMINED)
      {
        Analyse_Supervisory_Sequence_2();
       }
    Track0_IO.Byte = (BYTE) 0;

        Temp_IO.Bit.b0 = PORTBbits.RB4;
        Temp_IO.Bit.b1 = PORTBbits.RB4;
        Temp_IO.Bit.b2 = PORTCbits.RC4;
        Temp_IO.Bit.b3 = PORTCbits.RC4;
        Track0_IO.Bit.b0 = (Temp_IO.Bit.b0 & Temp_IO.Bit.b1);
        Track0_IO.Bit.b1 = (Temp_IO.Bit.b2 & Temp_IO.Bit.b3);
        Determine_TrackState_2(Track0_IO.Byte);
        Monitor_Wheel_Pulse_2(Track0_IO);
        Detect_PD_Failures_2();
...
Input Variables             Name                                Type
    Global          :   Track_Info_2.Flags.PD1S_Port_Latch        Bit
                        Track_Info_2.PD1S_Falling_Edge_Count      UINT16
                        Track_Info_2.PD1S_Count                   UINT16
                        Track_Info_2.PD1S_Rising_Edge_Count       UINT16
                        Track_Info_2.Flags.PD2S_Port_Latch        Bit
...
Output Variables            Name                                Type
    Global          :   Track_Info_2.Flags.PD1S_Timer_On          Bit
                        Track_Info_2.PD1S_Timeout_50ms            UNIT16
                        Track_Info_2.PD_Last_Change_Timeout_50ms  BYTE
                        Track_Info_2.PD1S_Falling_Edge_Count      UINT16
                        Track_Info_2.PD1S_Count                   UINT16
                        ...
                        Track_Info_2.Flags.PD1S_Port_Latch        Bit
                        Track_Info_2.Flags.PD2S_Timer_On          Bit
                        Track_Info_2.PD2S_Timeout_50ms            BYTE
                        Track_Info_2.PD2S_Falling_Edge_Count      UINT16
                        Track_Info_2.PD2S_Rising_Edge_Count       UINT16
                        Track_Info_2.PD2S_Count                   UINT16
                        Track_Info_2.Flags.PD2S_Port_Latch        Bit
...
void Monitor_Supervisory_Pulse_2(void)
{
    ...
    {
        if (Track_Info_2.Flags.PD1S_Port_Latch == SET_HIGH)
        {
            /*
             ...
             */
            Track_Info_2.Flags.PD1S_Timer_On = TRUE;
            Track_Info_2.PD1S_Timeout_50ms = PD_SUPERVISORY_LOW_TIMEOUT;
            Track_Info_2.PD_Last_Change_Timeout_50ms  = PD_CLEARING_TIMEOUT;
            Track_Info_2.PD1S_Falling_Edge_Count = Track_Info_2.PD1S_Falling_Edge_Count + 1;
        }
    }
    else
    {
        if (Track_Info_2.Flags.PD1S_Port_Latch == SET_LOW)
        {
            /*
            ...
            Track_Info_2.PD1S_Timeout_50ms = 0;
            Track_Info_2.PD_Last_Change_Timeout_50ms  = PD_CLEARING_TIMEOUT;
            Track_Info_2.PD1S_Count = Track_Info_2.PD1S_Count + 1;
            Track_Info_2.PD1S_Rising_Edge_Count = Track_Info_2.PD1S_Rising_Edge_Count + 1;
        }
    }
    Track_Info_2.Flags.PD1S_Port_Latch = PortB_Buffer.Bit.b0;

    if (PortB_Buffer.Bit.b1 == SET_LOW)
    {
        if (Track_Info_2.Flags.PD2S_Port_Latch == SET_HIGH)
        {
            /*
             * Supervisory pulse transition from HIGH to LOW indicates train axle
             * has just started to enter/exit the magnetic field in PD range and
             * phase reversal has just begun.
             */
            Track_Info_2.Flags.PD2S_Timer_On = TRUE;
            Track_Info_2.PD2S_Timeout_50ms = PD_SUPERVISORY_LOW_TIMEOUT;
            Track_Info_2.PD_Last_Change_Timeout_50ms  = PD_CLEARING_TIMEOUT;
            Track_Info_2.PD2S_Falling_Edge_Count = Track_Info_2.PD2S_Falling_Edge_Count + 1;
        }
    }
    else
    {
        if (Track_Info_2.Flags.PD2S_Port_Latch == SET_LOW)
        {
            /*
             * Supervisory pulse transition from LOW to HIGH indicates that
             * phase reversal is completed and PDx_PULSE starts to change
            ...
            Track_Info_2.PD2S_Timeout_50ms = 0;
            Track_Info_2.PD_Last_Change_Timeout_50ms  = PD_CLEARING_TIMEOUT;
            Track_Info_2.PD2S_Rising_Edge_Count = Track_Info_2.PD2S_Rising_Edge_Count + 1;
            Track_Info_2.PD2S_Count = Track_Info_2.PD2S_Count + 1;
        }
    }
    Track_Info_2.Flags.PD2S_Port_Latch = PortB_Buffer.Bit.b1;
}


/*********************************************************************
Component name      :AXLE_MON
Module Name         :void Monitor_Wheel_Pulse_2(void)
Created By          :
Date Created        :
Modification History:
                    |-------------|---------------|-----------------|-------------|------------------------------|
...
Input Variables             Name                                Type
    Global          :   Track_Info_2.Flags.PD1M_Port_Latch        Bit
                        Track_Info_2.PD1M_Count                   UINT16
                        Track_Info_2.Flags.PD2M_Port_Latch        Bit
                        Track_Info_2.PD2M_Count                   UINT16
...
Output Variables            Name                                Type
    Global          :   Track_Info_2.PD1M_Count                   UINT16
                        Track_Info_2.Flags.PD1M_Port_Latch        Bit
                        Track_Info_2.PD2M_Count                   UINT16
                        Track_Info_2.Flags.PD2M_Port_Latch        Bit
...
************************************************************************/
void Monitor_Wheel_Pulse_2( bitadrb_t Temp_IO)
{

    if (Temp_IO.Bit.b1 == SET_HIGH &&
        Track_Info_2.Flags.PD1M_Port_Latch == SET_LOW)
    {
        /*
         * Main pulse transition from HIGH to LOW indicates train axle
         * Going away from Pd. So, Pulse count will be incrementd
        */
         Track_Info_2.PD1M_Count = Track_Info_2.PD1M_Count + 1;
    }
    Track_Info_2.Flags.PD1M_Port_Latch = Temp_IO.Bit.b1;

    if (Temp_IO.Bit.b0 == SET_HIGH &&
        Track_Info_2.Flags.PD2M_Port_Latch == SET_LOW)
    {
        /*
         * Main pulse transition from HIGH to LOW indicates train axle
         * Going away from Pd. So, Pulse count will be incrementd
        */
         Track_Info_2.PD2M_Count = Track_Info_2.PD2M_Count + 1;
    }
    Track_Info_2.Flags.PD2M_Port_Latch = Temp_IO.Bit.b0;
}

/*********************************************************************
Component name      :AXLE_MON
Module Name         :void Determine_TrackState_2(BYTE uchPD_IO_Value)
Created By          :
Date Created        :
Modification History:
                    |-------------|---------------|-----------------|-------------|------------------------------|
...
Interfaces
    Calls           :   AXLE_MON.c  -   Clear_PD1_Supervisory_Count_2()
                        AXLE_MON.c  -   Clear_PD2_Supervisory_Count_2()
                        AXLE_MON.C  -   Register_PD1212_Transition_2()
                        AXLE_MON.c  -   Register_PD2121_Transition_2()
                        RELAYMGR.c  -   Declare_DAC_Defective()
                        ERROR.C     -   Set_Error_Status_Bit()
...
void Determine_TrackState_2(BYTE uchPD_IO_Value)
{
    ...
    if (uchPD_IO_Value >= NO_OF_PD_TRANSITIONS)
        return;
    uchNewState = uchPD_Transition_Table[Track_Info_2.State][uchPD_IO_Value];

    switch (Track_Info_2.State)
    {
        ...
        case WAIT_FOR_AXLE_AT_TRAILING_PD:
            if (uchNewState == LET_AXLE_CLEAR_LEADING_PD_FIRST)
                ...
                /* wheel is moving forward to middle of Both PD, So clear the sup errors */
                    Clear_PD1_Supervisory_Count_2();
                    Clear_PD2_Supervisory_Count_2();
                }
            if(uchNewState == WAITING_FOR_AXLE)
              {
                Track_Info_2.Flags.PD_Without_Overlapping = TRUE;
              }
            break;
       ...
       Track_Info_2.State = uchNewState;
       if(Track_Info_2.State != WAITING_FOR_AXLE )
        {
         Track_Info_2.PD_Last_Change_Timeout_50ms  = PD_CLEARING_TIMEOUT;
        }
}
...
/*********************************************************************
Component name      :AXLE_MON
Module Name         :void Analyse_Supervisory_Sequence_2(void)
Created By          :
Date Created        :
Modification History:
                    |-------------|---------------|-----------------|-------------|------------------------------|
...
Input Variables         Name                                    Type
    Global          :   Track_Info_2.PD1S_Falling_Edge_Count      UINT16
                        Track_Info_2.PD2S_Falling_Edge_Count      UINT16
                        Track_Info_2.PD1S_Rising_Edge_Count       UINT16
                        Track_Info_2.PD2S_Rising_Edge_Count       UINT16
...
void Analyse_Supervisory_Sequence_2(void)
{
  ...
  if(Track_Info_2.PD1S_Falling_Edge_Count == 1 &&
     Track_Info_2.PD2S_Falling_Edge_Count == 1 )
     {
       if(Track_Info_2.PD1S_Rising_Edge_Count == 0 &&
         Track_Info_2.PD2S_Rising_Edge_Count == 0 )
         {
          Track_Info_2.Wheel_Type = TRAIN_WHEEL_WITH_SINGLE_SUP;
         }
         else
         {
          Track_Info_2.Wheel_Type = TRAIN_WHEEL_WITH_DOUBLE_SUP;
         }
        return;
     }
    if(Track_Info_2.PD1S_Rising_Edge_Count == 1 &&
       Track_Info_2.PD2S_Rising_Edge_Count == 1 )
    {
       Track_Info_2.Wheel_Type = TRAIN_WHEEL_WITH_DOUBLE_SUP;
       return;
    }
...
/*********************************************************************
Component name      :AXLE_MON
Module Name         :void Detect_PD_Failures_2(void)
Created By          :
Date Created        :
Modification History:
                    |-------------|---------------|-----------------|-------------|------------------------------|
...
Interfaces
    Calls           :   AXLE_MON.c  -   Clear_PD1_Supervisory_Count_2()
                        AXLE_MON.c  -   Clear_PD2_Supervisory_Count_2()
                        AXLE_MON.c  -   Clear_PD12_Main_Pulse_Count_2()
                        AXLE_MON.c  -   Clear_Wheel_Type_2()
                        ERROR.c     -   Set_Error_Status_Bit()
                        RELAYMGR.c  -   Declare_DAC_Defective()
...
Input Variables         Name                                                        Type
    Global          :   Track_Info_2.Flags.PD_State_Counted                           Bit
                        Track_Info_2.PD_Last_Change_Timeout_50ms                      BYTE
                        Track_Info_2.Flags.PD1S_Timer_On                              Bit
                        Track_Info_2.PD1S_Timeout_50ms                                UNIT16
                        Track_Info_2.Flags.PD2S_Timer_On                              Bit
                        ...
                        Track_Info_2.PD1S_Count                                       UINT16
                        Track_Info_2.PD2S_Count                                       UINT16
                        Track_Info_2.Wheel_Type                                       Enumerator
                        TRAIN_WHEEL_WITH_SINGLE_SUP                                 Enumerator
                        TRAIN_WHEEL_WITH_DOUBLE_SUP                                 Enumerator
                        Track_Info_2.US_Local_Counts_Clearing_Flag_Timeout_50ms       BYTE
                        Track_Info_2.DS_Local_Counts_Clearing_Flag_Timeout_50ms       BYTE
                        Track_Info_2.Flags.US_Local_Counts_Just_Cleared               Bit
                        Track_Info_2.Flags.DS_Local_Counts_Just_Cleared               Bit
    Local           :   None
...
void Detect_PD_Failures_2(void)
{
   if(Track_Info_2.Flags.PD_State_Counted == TRUE)
    {
         /* Wheel counted .so, clear the PD state errors. Because of Trolley    */
         Clear_PD1_Supervisory_Count_2();
         Clear_PD2_Supervisory_Count_2();
         Clear_PD12_Main_Pulse_Count_2();
         Clear_Wheel_Type_2();
         Track_Info_2.Flags.PD_State_Counted =FALSE;
         Track_Info_2.Flags.PD_Non_Overlapping = FALSE;
     return;
    }
    if(Track_Info_2.US_Local_Counts_Clearing_Flag_Timeout_50ms == TIMEOUT_EVENT)
     {
      Track_Info_2.Flags.US_Local_Counts_Just_Cleared = SET_LOW;
     }
    if(Track_Info_2.DS_Local_Counts_Clearing_Flag_Timeout_50ms == TIMEOUT_EVENT)
     {
      Track_Info_2.Flags.DS_Local_Counts_Just_Cleared = SET_LOW;
     }
    if(Track_Info_2.PD_Last_Change_Timeout_50ms == TIMEOUT_EVENT )
    {
  ...
  if(!Chk_For_Track_Occupancy_2())
   {
    if (Track_Info_2.Flags.PD1S_Timer_On == TRUE && Track_Info_2.PD1S_Timeout_50ms == TIMEOUT_EVENT)
      {
     ...
     if (Track_Info_2.Flags.PD2S_Timer_On == TRUE && Track_Info_2.PD2S_Timeout_50ms == TIMEOUT_EVENT)
     {
     ...
     if(Track_Info_2.PD1M_Count >=2 && Track_Info_2.PD2M_Count == 0 &&
        Track_Info_2.State == WAITING_FOR_AXLE)
     {
     ...
     if(Track_Info_2.PD1M_Count >=2 &&
       Track_Info_2.PD1S_Count > 2 && Track_Info_2.PD2S_Count == 0)
     {
        Set_Error_Status_Bit (AD1_PULSING_ERROR_NUM);
        Status.Flags.PD1_Status = PHASE_DETECTOR_FAILED;
        Declare_DAC_Defective();
     ...
     if(Track_Info_2.PD2M_Count >=2 && Track_Info_2.PD1M_Count == 0 &&
        Track_Info_2.State == WAITING_FOR_AXLE)
     {
     ...
     if(Track_Info_2.PD2M_Count >=2  &&
       Track_Info_2.PD2S_Count > 2 && Track_Info_2.PD1S_Count == 0)
     {
        Set_Error_Status_Bit (AD2_PULSING_ERROR_NUM);
        Status.Flags.PD2_Status = PHASE_DETECTOR_FAILED;
        Declare_DAC_Defective();
     ...
     if(Track_Info_2.PD1M_Count >=4 && Track_Info_2.PD2M_Count >=4)
     {
    ...
    if(Track_Info_2.PD1M_Count >=4 && Track_Info_2.PD2M_Count == 0 &&
        Track_Info_2.State == WAITING_FOR_AXLE)
     {
        Set_Error_Status_Bit (AD1_PULSING_ERROR_NUM);
        Status.Flags.PD1_Status = PHASE_DETECTOR_FAILED;
    ...
    if(Track_Info_2.PD2M_Count >=4 && Track_Info_2.PD1M_Count == 0 &&
        Track_Info_2.State == WAITING_FOR_AXLE)
     {
        Set_Error_Status_Bit (AD2_PULSING_ERROR_NUM);
        Status.Flags.PD2_Status = PHASE_DETECTOR_FAILED;
    ...
    if(Track_Info_2.PD1M_Count == 1 && Track_Info_2.PD2M_Count == 1 &&
       Track_Info_2.PD1S_Count == 0 && Track_Info_2.PD2S_Count == 0 &&
       Track_Info_2.Flags.PD_Without_Overlapping == TRUE)
    {
    ...
    if(Track_Info_2.PD1M_Count >= 1 && Track_Info_2.PD2M_Count >= 1 &&
       Track_Info_2.Flags.PD_Without_Overlapping == TRUE &&
       Track_Info_2.Trolley_Timeout_50ms != TIMEOUT_EVENT )
    {
  ...
  switch(Track_Info_2.Wheel_Type)
    {
        case TRAIN_WHEEL_WITH_SINGLE_SUP:
            if(Track_Info_2.PD1S_Count >= 2 && Track_Info_2.PD2S_Count >= 2)
            {
            ...
            if(Track_Info_2.PD1S_Count > 1 && Track_Info_2.PD2S_Count > 1 &&
               Track_Info_2.PD1M_Count ==0  && Track_Info_2.PD2M_Count == 0)
            {
        ...
        case TRAIN_WHEEL_WITH_DOUBLE_SUP:
            if(Track_Info_2.PD1S_Count >= 4 && Track_Info_2.PD2S_Count >= 4)
            {
           ...
           break;
        default:
          if(Track_Info_2.PD1M_Count > 2 && Track_Info_2.PD2M_Count > 2)
            {
          ...
          if(Track_Info_2.PD1M_Count ==0 &&  Track_Info_2.PD2M_Count == 0)
            {
             if(Track_Info_2.PD1S_Count > 4 || Track_Info_2.PD2S_Count > 4)
              {
               Set_Error_Status_Bit (AD_SUP_PULSATING_ERROR_NUM);
...
/*********************************************************************
Component name      :AXLE_MON
Module Name         :void Register_PD1212_Transition_2(void)
Created By          :
Date Created        :
Modification History:
                    |-------------|---------------|-----------------|-------------|------------------------------|
...
Interfaces
    ...
    Called by       :   AXLE_MON.c  -   Determine_TrackState_2()

Input Variables         Name                                    Type
    Global          :   Track_Info_2.Flags.US_Counting_Enable     Bit
                        Track_Info_2.US_Axle_Direction            BYTE
                        Track_Info_2.Flags.DS_Counting_Enable     Bit
                        Track_Info_2.DS_Axle_Direction            BYTE
                        DIRECTION_NOT_DEFINED                   Enumerator
...
void Register_PD1212_Transition_2(void)
{
    ...
    Track_Info_2.Flags.PD_State_Counted = TRUE;
    Track_Info_2.Trolley_Timeout_50ms = TROLLEY_TIMEOUT;
#if NO_SHUNTING
    Track_Info_2.LCWS_Axle_Direction = FORWARD_DIRECTION;
    Track_Info_2.LCWS_Fwd_Count = Track_Info_2.LCWS_Fwd_Count + 1;
    if (Track_Info_2.LCWS_Total_Fwd_Count >= MAX_AXLE_COUNTS)
    {
        Track_Info_2.LCWS_Total_Fwd_Count = 0;
    }
    else
    {
        Track_Info_2.LCWS_Total_Fwd_Count = Track_Info_2.LCWS_Total_Fwd_Count + 1;
    }
#else
    if(Track_Info_2.LCWS_Axle_Direction == DIRECTION_NOT_DEFINED || Track_Info_2.LCWS_Axle_Direction == FORWARD_DIRECTION)
    {
        Track_Info_2.LCWS_Axle_Direction = FORWARD_DIRECTION;
        Track_Info_2.LCWS_Fwd_Count = Track_Info_2.LCWS_Fwd_Count + 1;
        if (Track_Info_2.LCWS_Total_Fwd_Count >= MAX_AXLE_COUNTS)
    ...
    else if(Track_Info_2.LCWS_Axle_Direction == REVERSE_DIRECTION)
    {
        Track_Info_2.LCWS_Rev_Count = Track_Info_2.LCWS_Rev_Count - 1;
        if (Track_Info_2.LCWS_Total_Rev_Count >= MAX_AXLE_COUNTS)
        {
            Track_Info_2.LCWS_Total_Rev_Count = 0;
        }
        else
        {
            Track_Info_2.LCWS_Total_Rev_Count = Track_Info_2.LCWS_Total_Rev_Count - 1;
        }
    }
#endif
}
/**************************************************************************
Component name      :AXLE_MON
Module Name         :void Register_PD2121_Transition_2(void)
Created By          :
Date Created        :
Modification History:
                    |-------------|---------------|-----------------|-------------|------------------------------|
...
void Register_PD2121_Transition_2(void)
{
    ...
    Track_Info_2.Trolley_Timeout_50ms = TROLLEY_TIMEOUT;
#if NO_SHUNTING
    Track_Info_2.LCWS_Axle_Direction = REVERSE_DIRECTION;
    Track_Info_2.LCWS_Rev_Count = Track_Info_2.LCWS_Rev_Count + 1;
    if (Track_Info_2.LCWS_Total_Rev_Count >= MAX_AXLE_COUNTS)
    {
        Track_Info_2.LCWS_Total_Rev_Count = 0;
    ...
    if(Track_Info_2.LCWS_Axle_Direction == DIRECTION_NOT_DEFINED || Track_Info_2.LCWS_Axle_Direction == REVERSE_DIRECTION)
    {
        Track_Info_2.LCWS_Axle_Direction = REVERSE_DIRECTION;
        Track_Info_2.LCWS_Rev_Count = Track_Info_2.LCWS_Rev_Count + 1;
        if (Track_Info_2.LCWS_Total_Rev_Count >= MAX_AXLE_COUNTS)
...
Input Variables         Name                                    Type
    Global          :   Track_Info_2.US_Axle_Count                UINT16
                        DIRECTION_NOT_DEFINED                   Enumerator
                        Track_Info_2.DS_Axle_Count                UINT16
...
Output Variables        Name                                    Type
    Global          :   Track_Info_2.US_Axle_Direction            BYTE
                        Track_Info_2.DS_Axle_Direction            BYTE
...
************************************************************************/
void Chk_for_AxleCount_Completion_2(void)
{
    if (Track_Info_2.LCWS_Fwd_Count == 0 && Track_Info_2.LCWS_Rev_Count == 0)
    {
        Track_Info_2.LCWS_Axle_Direction = DIRECTION_NOT_DEFINED;
    }
    if (Track_Info_2.LCWS_Fwd_Count > MAX_AXLE_COUNTS )
    {
        Set_Error_Status_Bit(INOPERATIVE_COUNTS_ERROR_NUM);
        Declare_DAC_Defective();
    }
    if (Track_Info_2.LCWS_Rev_Count > MAX_AXLE_COUNTS )
    {
        Set_Error_Status_Bit(INOPERATIVE_COUNTS_ERROR_NUM);
        Declare_DAC_Defective();
    }
...
Input Variables         Name                                                      Type
    Global          :   Track_Info_2.PD_Last_Change_Timeout_50ms                    BYTE
                        Track_Info_2.PD1S_Timeout_50ms                              UNIT16
                        Track_Info_2.PD2S_Timeout_50ms                              UNIT16
                        Track_Info_2.Local_Counts_Clearing_Flag_Timeout_50ms        BYTE
                        Track_Info_2.Trolley_Timeout_50ms                           BYTE
...
void Decrement_TrackMon_50msTmr_2(void)
{
    if (Track_Info_2.PD_Last_Change_Timeout_50ms > 0)
    {
        Track_Info_2.PD_Last_Change_Timeout_50ms = Track_Info_2.PD_Last_Change_Timeout_50ms - 1;
    }
    if (Track_Info_2.PD1S_Timeout_50ms > 0)
    {
        Track_Info_2.PD1S_Timeout_50ms = Track_Info_2.PD1S_Timeout_50ms - 1;
    }
    if (Track_Info_2.PD2S_Timeout_50ms > 0)
    {
        Track_Info_2.PD2S_Timeout_50ms = Track_Info_2.PD2S_Timeout_50ms - 1;
    }
    if(Track_Info_2.US_Local_Counts_Clearing_Flag_Timeout_50ms > 0)
      {
        Track_Info_2.US_Local_Counts_Clearing_Flag_Timeout_50ms = Track_Info_2.US_Local_Counts_Clearing_Flag_Timeout_50ms - 1;
      }
    if(Track_Info_2.DS_Local_Counts_Clearing_Flag_Timeout_50ms > 0)
      {
        Track_Info_2.DS_Local_Counts_Clearing_Flag_Timeout_50ms = Track_Info_2.DS_Local_Counts_Clearing_Flag_Timeout_50ms - 1;
      }
    if(Track_Info_2.Trolley_Timeout_50ms > 0)
      {
        Track_Info_2.Trolley_Timeout_50ms = Track_Info_2.Trolley_Timeout_50ms - 1;
      }
}
/*********************************************************************
Component name      :AXLE_MON
...
************************************************************************/
void Clear_US_AxleCount_2(void)
{
    Track_Info_2.US_Axle_Direction = DIRECTION_NOT_DEFINED;
    Track_Info_2.US_Axle_Count = 0;
    Track_Info_2.Flags.US_Local_Counts_Just_Cleared = SET_HIGH;
    Track_Info_2.US_Local_Counts_Clearing_Flag_Timeout_50ms = LOCAL_COUNT_CLEARING_FLAG_TIMEOUT;
    Clear_PD1_Supervisory_Count_2();
    Clear_PD2_Supervisory_Count_2();
    Clear_Wheel_Type_2();
...
Output Variables        Name                                              Type
    Global          :   Track_Info_2.DS_Axle_Direction                      BYTE
                        Track_Info_2.Flags.Train_Shunting                   Bit
                        Track_Info_2.DS_Axle_Count                          UINT16
                        Track_Info_2.Flags.DS_Local_Counts_Just_Cleared     Bit
                        Track_Info_2.Local_Counts_Clearing_Flag_Timeout_50ms BYTE
...
void Clear_DS_AxleCount_2(void)
{
    Track_Info_2.DS_Axle_Direction = DIRECTION_NOT_DEFINED;
    Track_Info_2.DS_Axle_Count = 0;
    Track_Info_2.Flags.DS_Local_Counts_Just_Cleared = SET_HIGH;
    Track_Info_2.DS_Local_Counts_Clearing_Flag_Timeout_50ms = LOCAL_COUNT_CLEARING_FLAG_TIMEOUT;
    Clear_PD1_Supervisory_Count_2();
    Clear_PD2_Supervisory_Count_2();
    Clear_Wheel_Type_2();
}
...
************************************************************************/
UINT16 Get_US_AxleCount_2(void)
{
    return Track_Info_2.US_Axle_Count;
}
/*********************************************************************
Component name      :AXLE_MON
...
Output Variables        Name                        Type
    Global          :   Track_Info_2.DS_Axle_Count    UINT16
...
************************************************************************/
UINT16 Get_DS_AxleCount_2(void)
{
    return Track_Info_2.DS_Axle_Count;
}
/*********************************************************************
Component name      :AXLE_MON
...
************************************************************************/
BYTE Get_US_AxleDirection_2(void)
{
    return Track_Info_2.US_Axle_Direction;
}
/*********************************************************************
Component name      :AXLE_MON
...
************************************************************************/
BYTE Get_DS_AxleDirection_2(void)
{
    return Track_Info_2.DS_Axle_Direction;
}
/*********************************************************************
Component name      :AXLE_MON
...
Output Variables        Name                            Type
    Global          :   Track_Info_2.US_Fwd_Axle_Count    UINT16
...
************************************************************************/
UINT16 Get_US_Fwd_AxleCount_2(void)
{
    return Track_Info_2.US_Fwd_Axle_Count;
}
/*********************************************************************
Component name      :AXLE_MON
...
Output Variables        Name                            Type
    Global          :   Track_Info_2.US_Rev_Axle_Count    UINT16
...
************************************************************************/
UINT16 Get_US_Rev_AxleCount_2(void)
{
    return Track_Info_2.US_Rev_Axle_Count;
}
/*********************************************************************
Component name      :AXLE_MON
...
Output Variables        Name                            Type
    Global          :   Track_Info_2.DS_Fwd_Axle_Count    UINT16
...
************************************************************************/
UINT16 Get_DS_Fwd_AxleCount_2(void)
{
    return Track_Info_2.DS_Fwd_Axle_Count;
}
/*********************************************************************
Component name      :AXLE_MON
...
Output Variables        Name                            Type
    Global          :   Track_Info_2.DS_Rev_Axle_Count    UINT16
...
************************************************************************/
UINT16 Get_DS_Rev_AxleCount_2(void)
{
    return Track_Info_2.DS_Rev_Axle_Count;
}
/*********************************************************************
Component name      :AXLE_MON
...
************************************************************************/
void Clear_DS_Local_Counts_2(void)
{
    Track_Info_2.DS_Fwd_Axle_Count = 0;
    Track_Info_2.DS_Rev_Axle_Count = 0;
}
...
************************************************************************/
void Clear_US_Local_Counts_2(void)
{
    Track_Info_2.US_Fwd_Axle_Count = 0;
    Track_Info_2.US_Rev_Axle_Count = 0;
}
/*********************************************************************
Component name      :AXLE_MON
Module Name         :void Clear_PD1_Supervisory_Count_2(void)
Created By          :
Date Created        :
Modification History:
                    |-------------|---------------|-----------------|-------------|------------------------------|
...
Output Variables            Name                            Type
    Global          :   Track_Info_2.PD1S_Count               UINT16
                        Track_Info_2.PD1S_Falling_Edge_Count  UINT16
                        Track_Info_2.PD1S_Rising_Edge_Count   UINT16
...
/*********************************************************************
Component name      :AXLE_MON
Module Name         :void Clear_PD2_Supervisory_Count_2(void)
Created By          :
Date Created        :
Modification History:
                    |-------------|---------------|-----------------|-------------|------------------------------|
...
Output Variables            Name                            Type
    Global          :   Track_Info_2.PD2S_Count               UINT16
                        Track_Info_2.PD2S_Falling_Edge_Count  UINT16
                        Track_Info_2.PD2S_Rising_Edge_Count   UINT16
...
/*********************************************************************
Component name      :AXLE_MON
Module Name         :void Clear_PD12_Main_Pulse_Count_2(void)
Created By          :
Date Created        :
Modification History:
                    |-------------|---------------|-----------------|-------------|------------------------------|
...
Interfaces
    ...
    Called by       :   AXLE_MON.c  -   Detect_PD_Failures_2()
...
/*********************************************************************
Component name      :AXLE_MON
Module Name         :void Clear_Wheel_Type_2(void)
Created By          :
Date Created        :
Modification History:
                    |-------------|---------------|-----------------|-------------|------------------------------|
...
void Clear_Wheel_Type_2(void)
{
    ...
    if (Track_Info_2.LCWS_Rev_Count == 0)
    {
    Track_Info_2.Wheel_Type = WHEEL_TYPE_NOT_DETERMINED;
    }
    if(Track_Info_2.PD1M_Count == 0 && Track_Info_2.PD2M_Count == 0)
...
************************************************************************/
void Start_US_Axle_Counting_2(void)
{
 Track_Info_2.Flags.US_Counting_Enable = SET_HIGH;
}

//01/09/10
void Start_FDP_US_Axle_Counting_2(void)
{
 Track_Info_2.Flags.FDP_US_Counting_Enable = SET_HIGH;
}
/*********************************************************************
Component name      :AXLE_MON
...
Output Variables        Name                                    Type
    Global          :   Track_Info_2.Flags.DS_Counting_Enable     Bit
...
Derived Requirements:
************************************************************************/
void Start_DS_Axle_Counting_2(void)
{
 Track_Info_2.Flags.DS_Counting_Enable = SET_HIGH;
}
//01/09/10
void Start_FDP_DS_Axle_Counting_2(void)
{
 Track_Info_2.Flags.FDP_DS_Counting_Enable = SET_HIGH;
}
/*********************************************************************
Component name      :AXLE_MON
...
Derived Requirements:
************************************************************************/
void Stop_US_Axle_Counting_2(void)
{
 Track_Info_2.Flags.US_Counting_Enable = SET_LOW;
}
//01/09/10
void Stop_FDP_US_Axle_Counting_2(void)
{
 Track_Info_2.Flags.FDP_US_Counting_Enable = SET_LOW;
}
/*********************************************************************
...
************************************************************************/
void Stop_DS_Axle_Counting_2(void)
{
 Track_Info_2.Flags.DS_Counting_Enable = SET_LOW;
}
//01/09/10

void Stop_FDP_DS_Axle_Counting_2(void)
{
 Track_Info_2.Flags.FDP_DS_Counting_Enable = SET_LOW;
}
/*********************************************************************
...
Modification History:
                    ...
                    |             |               |                 |             |                              |
                    |-------------|---------------|-----------------|----------- -|------------------------------|
Abstract                :Return the status of the flag Track_Info_2.Flags.DS_Local_Counts_Just_Cleared
...
Input Variables             Name                                                 Type
    Global          :   Track_Info_2.Flags.DS_Local_Counts_Just_Cleared            Bit
...
************************************************************************/
 BOOL Get_DS_Local_Counts_Clearing_Status_2(void)
{
  BOOL ReturnValue = FALSE;
   if(Track_Info_2.Flags.DS_Local_Counts_Just_Cleared == TRUE)
      {
...
Modification History:
                    ...
                    |             |               |                 |             |                              |
                    |-------------|---------------|-----------------|----------- -|------------------------------|
Abstract            :Return the status of the flag Track_Info_2.Flags.US_Local_Counts_Just_Cleared
...
Input Variables             Name                                          Type
    Global          :   Track_Info_2.Flags.US_Local_Counts_Just_Cleared      Bit
...
Algorithm           :1.If the Upstream local count cleared flag got setted
                        return the value as 1 otherwise return zero
************************************************************************/
BOOL Get_US_Local_Counts_Clearing_Status_2(void)
{
  BOOL ReturnValue = FALSE;
   if(Track_Info_2.Flags.US_Local_Counts_Just_Cleared == TRUE)
      {
         ReturnValue = (BOOL) SET_HIGH;
      }
  return(ReturnValue);
...
/*********************************************************************
Component name      :AXLE_MON
Module Name         :BOOL Chk_For_Track_Occupancy_2(void)
Created By          :
Date Created        :
Modification History:
                    |-------------|---------------|-----------------|-------------|------------------------------|
