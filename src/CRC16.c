...
unsigned char uchCRC16TableLo[256] = {
...
Modification History:
                    ...
                    |             |               |                 |             |                              |
                    |-------------|---------------|-----------------|----------- -|------------------------------|
Abstract            :Compute 16 bit cyclic redundancy check value

Allocated Requirements  :

Design Requirements     :SSDAC_DR_5032
...
Interfaces
    ...
    Called by       :   COMM_US.c   -   Receive_COM2_Message()
                        COMM_DS.c   -   Build_DS_Reset_Info_Message()
                        COMM_DS.c   -   Build_DS_Axle_Count_Message()
                        COMM-SM.c   -   Update_SPI_State()
                        COMM_SM.c   -   Build_Interprocess_Message()
                        COMM_US.c   -   Receive_COM1_Message()
                        COMM-US.c   -   Build_US_Reset_Info_Message()
...
Algorithm           :1.Initialize Low and  High byte of CRC to 0xFFFF
