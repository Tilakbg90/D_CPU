...
void Monitor_Wheel_Pulse_3(bitadrb_t);
void Determine_TrackState_3(BYTE);
void Analyse_Supervisory_Sequence_3(void);
void Register_PD1212_Transition_3(void);
void Register_PD2121_Transition_3(void);
void Clear_PD1_Supervisory_Count_3(void);
...
void Initialise_AxleMon_3(void)
{
    ...
    Track_Info_3.US_Axle_Direction = DIRECTION_NOT_DEFINED;
    Track_Info_3.DS_Axle_Direction = DIRECTION_NOT_DEFINED;
    Track_Info_3.US_Axle_Count = 0;
    Track_Info_3.DS_Axle_Count = 0;

    Track_Info_3.LCWS_Axle_Direction = DIRECTION_NOT_DEFINED;
...
void Determine_TrackState_3(BYTE uchPD_IO_Value)
{
    ...
    switch (Track_Info_3.State)
    {
       ...
       Track_Info_3.State = uchNewState;
...
************************************************************************/
void Clear_DS_Local_Counts_3(void)
{
    Track_Info_3.DS_Fwd_Axle_Count = 0;
    Track_Info_3.DS_Rev_Axle_Count = 0;
}
...
************************************************************************/
void Clear_US_Local_Counts_3(void)
{
    Track_Info_3.US_Fwd_Axle_Count = 0;
    Track_Info_3.US_Rev_Axle_Count = 0;
}
